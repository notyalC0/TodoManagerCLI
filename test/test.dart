...
void main() {
  group('Testes de TodoManager', () {
    ...
    test('Deve listar todas as tarefas', () {
      manager.adicionar('Tarefa 1', 'Desc 1', 1);
      manager.adicionar('Tarefa 2', 'Desc 2', 2);
    ...
    test('Deve editar uma tarefa existente', () {
      manager.adicionar('Título Antigo', 'Desc Antiga', 1);
      int id = manager.tarefas.first['id'];

      manager.editar(id, 'Novo Título', 'Nova Desc', 2);
    ...
    test('Deve excluir uma tarefa da lista', () {
      manager.adicionar('Tarefa para Morrer', 'Desc', 1);
      int id = manager.tarefas.first['id'];
    ...
    test('AlternarStatus deve inverter o valor booleano', () {
      manager.adicionar('Status Test', 'Desc', 1);
      int id = manager.tarefas.first['id'];
